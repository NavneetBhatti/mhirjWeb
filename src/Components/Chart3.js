...
export default function Chart3() {
  ...
  function submit_chart3(e) {
    ...
    const path = 'https://mhirjapi77.azurewebsites.net/api/chart_three/' + data_chart3.aircraft_no + '/' + data_chart3.equation_id + '/' + flightphase + '/' + data_chart3.from_date + '/' + data_chart3.to_date;
